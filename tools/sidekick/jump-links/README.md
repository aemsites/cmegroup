...
```html
<p><a href="https://main--www--cmegroup.aem.page/your/page/path#launch--overview" title="Launch Guide">Launch Guide</a></p>
<p><a href="https://main--www--cmegroup.aem.page/your/page/path#when-will-topix-products-become-available-for-trading-at-cme" title="TOPIX Availability">TOPIX Availability</a></p>
<p><a href="https://main--www--cmegroup.aem.page/your/page/path#trading-hours" title="Trading Hours">Trading Hours</a></p>
```
...
### File Structure
```
tools/sidekick/jump-links/
├── jump-links.html    # Plugin interface
├── jump-links.css     # Styling (DA platform native)
