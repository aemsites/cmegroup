...
const HERO_API_CONFIG = {
  endpoint: '/aemedge/blocks/dynamic/product-tabs/mock-api/contracts-by-number.json',
};
...
/**
 * Populate hero block with API data
 */
async function populateHeroData(block) {
  try {
    ...
    // Silently fail - hero will show with default/empty content
  }
}

/**
 * Decorate the hero baseball block
 */
export default async function decorate(block) {
  // Check if structure already exists or needs to be created
